...
public class AerospikeDataConverter
  ...
  private static final Logger LOG = LogManager.getLogger(AerospikeDataConverter.class);

  @Override
  public AerospikeDataModel convert(DataModel<Product, Warehouse, Employee, Carrier> model) {
